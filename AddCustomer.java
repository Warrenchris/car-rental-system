...
public class AddCustomer extends JFrame implements ActionListener {
    private JLabel lID, lpassword, lFirstName, lSecondName, lEmail, lPhoneNumber,
            lIDNO, lDayForRent,lBookingID, lCarName, lCarColour, lRegNo;

    private JTextField tID, tpassword, tFirstName, tSecondName, tEmail, tPhoneNumber,
            tIDNO,  tDayForRent, tBookingID, tCarName, tCarColour, tRegNo;
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == Add) {
            ...
            if(ID.equals("")||password.equalsIgnoreCase("") || firstName.equalsIgnoreCase("") || secondName.equalsIgnoreCase("") || email.equalsIgnoreCase("") || phoneNumber.equalsIgnoreCase("") || IDNO.equalsIgnoreCase("") || DayForRent.equalsIgnoreCase("") || CarName.equalsIgnoreCase("")|| CarColour.equalsIgnoreCase("") || carRegNO.equalsIgnoreCase("") || BookingID.equalsIgnoreCase("")){
            ...
            // making Customer
            Customer h = new Customer(firstName, secondName, email, phoneNumber, IDNO ,ID, m, BookingID, DayForRent, password);
