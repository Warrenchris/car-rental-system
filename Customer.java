...
public class Customer extends Person implements Serializable {
    ...
    public Customer(String firstName, String lastName, String email, String phoneNo, String IDNO, String ID, Car car, String BookingID, String dayForRent, String password) {
        super(firstName, lastName, email, phoneNo, IDNO);
        this.ID=ID;
